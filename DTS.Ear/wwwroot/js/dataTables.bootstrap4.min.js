...
(function (b) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function (a) { return b(a, window, document) }) : "object" === typeof exports ? module.exports = function (a, d) {
    ...
    var f = b.fn.dataTable; b.extend(!0, f.defaults, {
        oLanguage: {
            sSearch: "Arama :",
            sEmptyTable: "Görüntülenecek data bulunamadı",
            sLengthMenu: "Görüntüle _MENU_ kayıt",
            sInfo: " _START_ - _END_ arası kayıt gösteriliyor. Toplam kayıt _TOTAL_",
            oPaginate: {
                sFirst: "İlk",
                sLast: "Son",
                sNext: "Sonraki",
